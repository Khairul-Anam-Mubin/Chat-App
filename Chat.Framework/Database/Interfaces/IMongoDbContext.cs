...
namespace Chat.Framework.Database.Interfaces
{
    public interface IMongoDbContext
    {
        ...
        Task<bool> UpdateItemByFilterDefinitionAsync<T>(DatabaseInfo databaseInfo, FilterDefinition<T> filterDefinition, UpdateDefinition<T> updateDefinition) where T : class, IRepositoryItem;
